...
public class QPostTag extends EntityPathBase<PostTag> {
    ...
    private static final long serialVersionUID = -299103402L;
    ...
    public final com.inssider.api.domains.tag.entity.QTag tag;
    ...
    public QPostTag(Class<? extends PostTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.tag = inits.isInitialized("tag") ? new com.inssider.api.domains.tag.entity.QTag(forProperty("tag")) : null;
    }
